...
public class AutoSlideView extends AutoSlideBase implements ViewPager.OnPageChangeListener {
    ...
    //用于状态恢复时的Key
    private final String KEY_CURR_PAGE = "curr_page";
    //自动滑动状态是否开启
    private final String KEY_AUTO_SLIDE_ENABLED = "auto_slide_enabled";
    //
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        viewPager.setId(R.id.slideView);
        ...
        pageControl.setId(R.id.pageControl);
